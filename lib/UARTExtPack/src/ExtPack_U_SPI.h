 ...
 */
ext_pack_error_t send_ExtPack_SPI_String_to_slave(unit_t unit, uint8_t slave_id, const uint8_t* data);
 ...
 */
static inline ext_pack_error_t send_ExtPack_SPI_String(unit_t unit, const uint8_t* data) {
