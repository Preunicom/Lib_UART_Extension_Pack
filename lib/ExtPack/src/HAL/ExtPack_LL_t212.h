/**
* @file ExtPack_LL_t212.h
 *
 * @brief Low-level UART communication support for the ExtPack on ATtiny212.
 *
...
#ifndef EXTPACK_LL_T212_H
#define EXTPACK_LL_T212_H
